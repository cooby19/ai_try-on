...
1. 在 Supabase Dashboard 進 **SQL Editor**，依序執行 `001_init.sql`、`002_atomic_quota_insert.sql`、`003_direct_upload_constraints.sql`。
...
- [ ] `001`、`002`、`003` migrations 已依序在正式 Supabase 專案執行。
